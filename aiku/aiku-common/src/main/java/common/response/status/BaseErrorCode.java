...
public enum BaseErrorCode implements StatusCode{
    ...
    CAN_NOT_EXIT(40014, "실행중인 스케줄이 있습니다.", HttpStatus.BAD_REQUEST),
    NO_TERM_SCHEDULE(40015, "스케줄이 아직 종료되지 않았습니다.", HttpStatus.BAD_REQUEST),
    ALREADY_HAS_BETTING(40016, "이미 베팅이 존재합니다.", HttpStatus.BAD_REQUEST),
